...
class CategoryControllerTest extends WebTestCase
{
    ...
    public function testEditRouteAdminUser(): void
    {
        ...
        $expectedCategory->setName('Test Category Edited');
        $this->categoryService->add($expectedCategory);
        $expectedCategoryId = $expectedCategory->getId();

        // when
        $this->httpClient->followRedirects(true);
        $this->httpClient->request('GET', "/category/" . strval($expectedCategoryId) .'/edit');
        $resultStatusCode = $this->httpClient->getResponse()->getStatusCode();
